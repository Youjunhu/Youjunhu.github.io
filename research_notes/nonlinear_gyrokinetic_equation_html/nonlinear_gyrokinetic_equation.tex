...
/ \partial \alpha$. Note that $x'$, $y'$ and $v_{\perp}'$ do not appear in Eq.
(\ref{22-11-16-3}), which means that the grids correspond to these variables
are not needed when numerically solving Eq. (\ref{22-11-16-3}) using Euler
grid-based methods, i.e., the dimesion of the problem is reduced. This
reduction will reduce the computational cost.
