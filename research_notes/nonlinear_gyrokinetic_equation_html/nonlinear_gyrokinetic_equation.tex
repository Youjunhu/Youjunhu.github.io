...
\begin{figure}[h]
  ...
  Hence \tmtexttt{mpol=nth+1}. \tmtexttt{nth} is denoted by \tmtexttt{ntheta}
  in GEM. The array starts at $\theta = - \pi$ and ends at $\theta = + \pi$
  ($\theta = \pm \pi$ is chosen to be at the high-field side in both the
  codes)
...
\begin{figure}[h]
  ...
  code, \tmtexttt{radcor\_1d\_array(1:nt)} and
  \tmtexttt{radcor\_1d\_array2(1:n)}, respctively corresponding to the
  ...
  (rather than 0). In the code $n$ is denoted by \tmtexttt{nflux2} and
...
\begin{figure}[h]
  ...
  point for density and potential arrays in my code is at \tmtexttt{mtor}
  rather than \tmtexttt{mtor+1}. \tmtexttt{GEM} array ends at \tmtexttt{jm}.
  It follows that \tmtexttt{mtor=jm}.}
\end{figure}
...
\begin{thebibliography}{1}
  ...
  \bibitem[4]{texmacs}Joris van der~Hoeven. {\newblock}Gnu texmacs, a
